...
export const PYTHIA_2_API = {
  ...
  managers: {
    list: '/managers',
    create: '/managers',
    archived: '/managers/archived',
    detail: (userId: string) => `/managers/${userId}`,
    credentials: (userId: string) => `/managers/${userId}/credentials`,
    archive: (userId: string) => `/managers/${userId}/archive`,
    unarchive: (userId: string) => `/managers/${userId}/unarchive`,
  },
  unknownIdentities: {
  ...
  stores: {
    ...
    activate: (storeCode: string) => `/stores/${storeCode}/activate`,
